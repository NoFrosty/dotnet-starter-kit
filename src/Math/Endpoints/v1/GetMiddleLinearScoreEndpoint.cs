...
public static class GetMiddleLinearScoreEndpoint
{
    internal static RouteHandlerBuilder MapGetMiddleLinearScoreEndpoint(this IEndpointRouteBuilder endpoints)
    {
        return endpoints
            ...
            .WithName(nameof(GetMiddleLinearScoreEndpoint))
