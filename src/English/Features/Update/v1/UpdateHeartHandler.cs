...
public sealed class UpdateHeartHandler(
    ...
    : IRequestHandler<UpdateHeartCommand, UpdateHeartResponse>
{
    public async Task<UpdateHeartResponse> Handle(UpdateHeartCommand request, CancellationToken cancellationToken)
    {
        ...
        var updatedHeart = heart.Update(request.AmountOfHeart);
